...
class ClusteringView(ttk.Frame):
    ...
    def _on_method_change(self, event=None): # ★★★ このメソッドを丸ごと追加
    ...
    def _perform_clustering(self, ax, df_features, title, method='ward'): # ★★★ method引数を追加
        """
    ...
    def save_plot(self, output_folder, timestamp, df_full_all_ids): # ★★★ method引数を削除
        """
