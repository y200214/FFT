...
class SpectrumView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        # Controller経由でConfigManagerにアクセスし、設定値を取得
        fft_config = self.controller.config_manager.get('fft_initial_view', {})
        initial_group = fft_config.get('variable_group', 'all')
        initial_show_fit = fft_config.get('show_fit_line', True)
        ...
        self.variable_group_var = tk.StringVar(value="all")
    ...
    def save_plot(self, output_folder, power_spectrums_data, progress_callback=None, timestamp=0, cancel_check=lambda: False):
        """
